...
class ActionColumn extends Column
{
    ...
    /** 
     * The controller class name that should handle the actions specified here.
     * @var string|null 
     */
    public $controller;
    ...
    /**
     * @param string $action The button name (the route name).
    ...
    public function createUrl($action, $model, $key, $index)
    {
        ...
        return $this->controller ? action([$this->controller, str_replace("-", "_", $action)], $params) : route($action, $params);
    }
        ...
        if (!isset($this->buttons[$name]) && strpos($this->template, '{' . $name . '}') !== false) {
            $this->buttons[$name] = function ($url, $model, $key) use ($name, $iconName, $additionalOptions) {
                ...
                $icon = isset($this->icons[$iconName])
                    ? $this->icons[$iconName]
                    : new HtmlString("<span class=\"bi bi-$iconName\"></span>");
